...
namespace SchoolProject.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var databaseContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseId,EnrolledOn")] Enrollment enrollment)
        {
